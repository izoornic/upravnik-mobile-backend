...
use App\Http\Resources\V1\VrstaZaduzenjaResource;
use App\Services\LegacyApiService;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\AnonymousResourceCollection;

class VrstaZaduzenjaController extends Controller
{
    ...
    public function index(Request $request, int $zgradaId): AnonymousResourceCollection
    {
        ...
        $vrste = $this->legacyApi->getVrsteZaduzenjaByZgrada($zgradaId);

        return VrstaZaduzenjaResource::collection($vrste);
    }
}
